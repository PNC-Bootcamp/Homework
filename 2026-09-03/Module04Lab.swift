...
// Not Required: id, status, category, merchantName
...
//
// Computed properties:
//   displayName: String          → nickname if non-nil, else 
...
//
//   recentTransactions: [Transaction]  → last 5, sorted by 
//                                          date descending
//
//   pendingCount: Int            → count of transactions with 
//                                          status .pending
//
//
